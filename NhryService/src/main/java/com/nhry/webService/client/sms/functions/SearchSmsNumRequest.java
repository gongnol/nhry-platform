...
/**
 *  SearchSmsNumRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SearchSmsNumRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.flaginfo.com.cn",
            "SearchSmsNumRequest", "ns1");
    ...
    public static class Factory {
         ...
         */
        public static SearchSmsNumRequest parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SearchSmsNumRequest".equals(type)) {
                            ...
                            return (SearchSmsNumRequest) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
