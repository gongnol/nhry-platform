/**
 * Z_CRM_PT_QUERY_RFCResponse.java
 *
...
/**
 *  Z_CRM_PT_QUERY_RFCResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Z_CRM_PT_QUERY_RFCResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:sap-com:document:sap:rfc:functions",
            "Z_CRM_PT_QUERY_RFC.Response", "ns1");
     ...
     */
    protected T_BALANCE_OUT_type0 localT_BALANCE_OUT;
     ...
     * @return com.nhry.webService.client.VipPoint.functions.ZSCRM_MESSAGE
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.VipPoint.functions.T_BALANCE_OUT_type0
     */
    public T_BALANCE_OUT_type0 getT_BALANCE_OUT() {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Z_CRM_PT_QUERY_RFC.Response", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Z_CRM_PT_QUERY_RFC.Response", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Z_CRM_PT_QUERY_RFCResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            Z_CRM_PT_QUERY_RFCResponse object = new Z_CRM_PT_QUERY_RFCResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Z_CRM_PT_QUERY_RFC.Response".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Z_CRM_PT_QUERY_RFCResponse) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "T_BALANCE_OUT").equals(reader.getName())) {
                            object.setT_BALANCE_OUT(T_BALANCE_OUT_type0.Factory.parse(
                                    reader));
