/**
 * Z_CRM_PT_ACCOUNT_QUERY_RFC.java
 *
...
/**
 *  Z_CRM_PT_ACCOUNT_QUERY_RFC bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Z_CRM_PT_ACCOUNT_QUERY_RFC implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:sap-com:document:sap:rfc:functions",
            "Z_CRM_PT_ACCOUNT_QUERY_RFC", "ns1");
     ...
     * @return com.nhry.webService.client.VipDetailData.functions.IV_CARD_ID_type1
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.VipDetailData.functions.IV_GUID_type1
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.VipDetailData.functions.IV_TEL_type1
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Z_CRM_PT_ACCOUNT_QUERY_RFC", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Z_CRM_PT_ACCOUNT_QUERY_RFC", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Z_CRM_PT_ACCOUNT_QUERY_RFC parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            Z_CRM_PT_ACCOUNT_QUERY_RFC object = new Z_CRM_PT_ACCOUNT_QUERY_RFC();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Z_CRM_PT_ACCOUNT_QUERY_RFC".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Z_CRM_PT_ACCOUNT_QUERY_RFC) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
