...
/**
 *  ReplyConfirmResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReplyConfirmResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.flaginfo.com.cn",
            "ReplyConfirmResponse", "ns1");
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReplyConfirmResponse".equals(type)) {
                            ...
                            return (ReplyConfirmResponse) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
