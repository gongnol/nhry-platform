...
/**
 *  ZSCRM_SNG_TS_QUERY bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSCRM_SNG_TS_QUERY implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ZSCRM_SNG_TS_QUERY
     ...
     * field for NZBH
     */
    protected NZBH_type1 localNZBH;
     ...
     * field for SNGBH
     */
    protected SNGBH_type1 localSNGBH;
     ...
     */
    protected Date localDATE_START;
     ...
     * @return com.nhry.webService.client.VipInfoData.functions.SALES_ORG_type1
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.VipInfoData.functions.NZBH_type1
     */
    public NZBH_type1 getNZBH() {
        return localNZBH;
    }
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.VipInfoData.functions.SNGBH_type1
     */
    public SNGBH_type1 getSNGBH() {
        return localSNGBH;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSCRM_SNG_TS_QUERY", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSCRM_SNG_TS_QUERY", xmlWriter);
            }
        }
        ...
        if (localDATE_ENDTracker) {
            ...
            localDATE_END.serialize(new javax.xml.namespace.QName("", "DATE_END"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ZSCRM_SNG_TS_QUERY parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ZSCRM_SNG_TS_QUERY object = new ZSCRM_SNG_TS_QUERY();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSCRM_SNG_TS_QUERY".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ZSCRM_SNG_TS_QUERY) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "NZBH").equals(
                            reader.getName())) {
                    object.setNZBH(NZBH_type1.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "SNGBH").equals(
                            reader.getName())) {
                    object.setSNGBH(SNGBH_type1.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "DATE_START").equals(
                            reader.getName())) {
                    object.setDATE_START(Date.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "DATE_END").equals(
                            reader.getName())) {
                    object.setDATE_END(Date.Factory.parse(
                            reader));
