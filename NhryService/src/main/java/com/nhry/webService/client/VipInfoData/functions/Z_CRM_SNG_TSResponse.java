...
/**
 *  Z_CRM_SNG_TSResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Z_CRM_SNG_TSResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     * @return com.nhry.webService.client.VipInfoData.functions.ET_DATA_type0
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Z_CRM_SNG_TS.Response", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Z_CRM_SNG_TS.Response", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Z_CRM_SNG_TSResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            Z_CRM_SNG_TSResponse object = new Z_CRM_SNG_TSResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Z_CRM_SNG_TS.Response".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Z_CRM_SNG_TSResponse) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
