...
public class ZSSD00023 implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for BUKRS
     */
    protected com.nhry.webService.client.masterData.functions.BUKRS_type3 localBUKRS;
     ...
     * field for WERKS
     */
    protected com.nhry.webService.client.masterData.functions.WERKS_type5 localWERKS;
     ...
     * field for NAME
     */
    protected com.nhry.webService.client.masterData.functions.NAME_type1 localNAME;
     ...
     * field for NAME2
     */
    protected com.nhry.webService.client.masterData.functions.NAME2_type3 localNAME2;
     ...
     */
    public com.nhry.webService.client.masterData.functions.BUKRS_type3 getBUKRS() {
        return localBUKRS;
    }
    ...
    public void setBUKRS(
        com.nhry.webService.client.masterData.functions.BUKRS_type3 param) {
     ...
     */
    public com.nhry.webService.client.masterData.functions.WERKS_type5 getWERKS() {
        return localWERKS;
    }
    ...
    public void setWERKS(
        com.nhry.webService.client.masterData.functions.WERKS_type5 param) {
     ...
     */
    public com.nhry.webService.client.masterData.functions.NAME_type1 getNAME() {
        return localNAME;
    }
     ...
     */
    public void setNAME(
        com.nhry.webService.client.masterData.functions.NAME_type1 param) {
     ...
     */
    public com.nhry.webService.client.masterData.functions.NAME2_type3 getNAME2() {
        return localNAME2;
    }
    ...
    public void setNAME2(
        com.nhry.webService.client.masterData.functions.NAME2_type3 param) {
        ...
        public static ZSSD00023 parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00023".equals(type)) {
                            ...
                            return (ZSSD00023) com.nhry.webService.client.masterData.functions.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "BUKRS").equals(
                            reader.getName())) {
                    object.setBUKRS(com.nhry.webService.client.masterData.functions.BUKRS_type3.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "WERKS").equals(
                            reader.getName())) {
                    object.setWERKS(com.nhry.webService.client.masterData.functions.WERKS_type5.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "NAME").equals(
                            reader.getName())) {
                    object.setNAME(com.nhry.webService.client.masterData.functions.NAME_type1.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "NAME2").equals(
                            reader.getName())) {
                    object.setNAME2(com.nhry.webService.client.masterData.functions.NAME2_type3.Factory.parse(
                            reader));
