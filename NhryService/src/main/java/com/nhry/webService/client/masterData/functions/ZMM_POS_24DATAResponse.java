...
public class ZMM_POS_24DATAResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for ET_DATA
     */
    protected com.nhry.webService.client.masterData.functions.ET_DATA_type0 localET_DATA;
     ...
     * field for ET_LGORT
     */
    protected com.nhry.webService.client.masterData.functions.ET_LGORT_type0 localET_LGORT;
     ...
     * field for IT_LGORT
     */
    protected com.nhry.webService.client.masterData.functions.IT_LGORT_type0 localIT_LGORT;
     ...
     * field for IT_WERKS
     */
    protected com.nhry.webService.client.masterData.functions.IT_WERKS_type0 localIT_WERKS;
     ...
     */
    public com.nhry.webService.client.masterData.functions.ET_DATA_type0 getET_DATA() {
        return localET_DATA;
    }
    ...
    public void setET_DATA(
        com.nhry.webService.client.masterData.functions.ET_DATA_type0 param) {
     ...
     */
    public com.nhry.webService.client.masterData.functions.ET_LGORT_type0 getET_LGORT() {
    ...
    public void setET_LGORT(
        com.nhry.webService.client.masterData.functions.ET_LGORT_type0 param) {
     ...
     */
    public com.nhry.webService.client.masterData.functions.IT_LGORT_type0 getIT_LGORT() {
    ...
    public void setIT_LGORT(
        com.nhry.webService.client.masterData.functions.IT_LGORT_type0 param) {
     ...
     */
    public com.nhry.webService.client.masterData.functions.IT_WERKS_type0 getIT_WERKS() {
    ...
    public void setIT_WERKS(
        com.nhry.webService.client.masterData.functions.IT_WERKS_type0 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZMM_POS_24DATA.Response".equals(type)) {
                            ...
                            return (ZMM_POS_24DATAResponse) com.nhry.webService.client.masterData.functions.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_DATA").equals(
                                    reader.getName())) {
                            object.setET_DATA(com.nhry.webService.client.masterData.functions.ET_DATA_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_LGORT").equals(
                                    reader.getName())) {
                            object.setET_LGORT(com.nhry.webService.client.masterData.functions.ET_LGORT_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "IT_LGORT").equals(
                                    reader.getName())) {
                            object.setIT_LGORT(com.nhry.webService.client.masterData.functions.IT_LGORT_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "IT_WERKS").equals(
                                    reader.getName())) {
                            object.setIT_WERKS(com.nhry.webService.client.masterData.functions.IT_WERKS_type0.Factory.parse(
                                    reader));
