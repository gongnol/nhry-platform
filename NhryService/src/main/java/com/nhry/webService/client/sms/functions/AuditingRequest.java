...
/**
 *  AuditingRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AuditingRequest implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AuditingRequest".equals(type)) {
                            ...
                            return (AuditingRequest) com.nhry.webService.client.sms.functions.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
