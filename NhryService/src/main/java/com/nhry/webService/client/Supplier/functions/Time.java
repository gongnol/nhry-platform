...
public class Time extends org.apache.axis2.databinding.types.Union implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setObject(java.lang.Object object) {
        if (object instanceof org.apache.axis2.databinding.types.Time) {
            this.localObject = object;
        } else if (object instanceof com.nhry.webService.client.Supplier.functions.GenericTime) {
            this.localObject = object;
        } else {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localObject instanceof org.apache.axis2.databinding.types.Time) {
            ...
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    (org.apache.axis2.databinding.types.Time) localObject));
        } else if (localObject instanceof com.nhry.webService.client.Supplier.functions.GenericTime) {
            java.lang.String namespacePrefix = registerPrefix(xmlWriter,
            ...
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    (com.nhry.webService.client.Supplier.functions.GenericTime) localObject));
        } else {
    ...
    public static class Factory {
        ...
        public static Time fromString(
            ...
            try {
                if ("http://www.w3.org/2001/XMLSchema".equals(namespaceURI)) {
                    ...
                    object = new Time();
                    object.setObject(com.nhry.webService.client.Supplier.functions.ExtensionMapper.getTypeObject(
        ...
        public static Time fromString(java.lang.String value,
            ...
            if (!isValueSet) {
                try {
                    java.lang.reflect.Method converterMethod = org.apache.axis2.databinding.utils.ConverterUtil.class.getMethod("convertToTime",
            ...
            if (!isValueSet) {
                try {
                    object.setObject(com.nhry.webService.client.Supplier.functions.GenericTime.Factory.fromString(
                            value, namespaceURI));
                    isValueSet = true;
                } catch (java.lang.Exception e) {
                }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        object = Time.Factory.fromString(reader, nsUri, type);
                    }
                } else {
                    ...
                    if (content.indexOf(":") > -1) {
                        ...
                        namespaceuri = reader.getNamespaceContext()
                                             .getNamespaceURI(prefix);
                        object = Time.Factory.fromString(content, namespaceuri);
                    } else {
                        object = Time.Factory.fromString(content, "");
                    }
                }
