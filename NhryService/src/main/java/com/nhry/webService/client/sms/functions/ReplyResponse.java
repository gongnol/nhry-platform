...
/**
 *  ReplyResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReplyResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.sms.functions.Reply[]
     */
     ...
     * @param param com.nhry.webService.client.sms.functions.Reply
     */
            ...
            if (localReplys != null) {
                for (int i = 0; i < localReplys.length; i++) {
                    if (localReplys[i] != null) {
                        localReplys[i].serialize(new javax.xml.namespace.QName(
                                "http://ws.flaginfo.com.cn", "replys"),
                            xmlWriter);
                    } else {
                        writeStartElement(null, "http://ws.flaginfo.com.cn",
                            "replys", xmlWriter);
                ...
                writeStartElement(null, "http://ws.flaginfo.com.cn", "replys",
                    xmlWriter);
    ...
    public static class Factory {
        ...
        public static ReplyResponse parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReplyResponse".equals(type)) {
                            ...
                            return (ReplyResponse) com.nhry.webService.client.sms.functions.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ws.flaginfo.com.cn", "confirm_time").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "confirm_time").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ws.flaginfo.com.cn", "id").equals(
                            reader.getName())) ||
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://ws.flaginfo.com.cn", "replys").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "replys").equals(
                            reader.getName())) {
