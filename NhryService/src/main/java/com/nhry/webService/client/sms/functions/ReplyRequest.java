...
/**
 *  ReplyRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReplyRequest implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReplyRequest".equals(type)) {
                            ...
                            return (ReplyRequest) com.nhry.webService.client.sms.functions.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
