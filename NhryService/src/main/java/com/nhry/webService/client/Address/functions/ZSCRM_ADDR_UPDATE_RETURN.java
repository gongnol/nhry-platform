...
/**
 *  ZSCRM_ADDR_UPDATE_RETURN bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSCRM_ADDR_UPDATE_RETURN implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ZSCRM_ADDR_UPDATE_RETURN
     ...
     * @return com.nhry.webService.client.Address.functions.FLAG_type1
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.Address.functions.MSG_type1
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.Address.functions.ADDRESS_GUID_type1
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSCRM_ADDR_UPDATE_RETURN", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSCRM_ADDR_UPDATE_RETURN", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ZSCRM_ADDR_UPDATE_RETURN parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ZSCRM_ADDR_UPDATE_RETURN object = new ZSCRM_ADDR_UPDATE_RETURN();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSCRM_ADDR_UPDATE_RETURN".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ZSCRM_ADDR_UPDATE_RETURN) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
